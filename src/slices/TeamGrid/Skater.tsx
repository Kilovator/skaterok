...
export function Skater({ skater, index }: Props) {
  ...
  return (
    <div className="skater group relative flex flex-col items-center gap-4 w-full">
      <div className="stack-layout relative overflow-hidden w-full aspect-[4/5] bg-brand-gray rounded-md">
        <Image
        ...
        <h3 className="relative z-30 grid place-self-end justify-self-start p-4 font-sans text-white ~text-2xl/3xl text-left w-full">
