...
const Hero = (): JSX.Element => {
  ...
  return (
    <Bounded className="bg-brand-black relative h-[75vh] min-h-[500px] lg:h-dvh overflow-hidden text-white bg-texture">
      ...
      <div className="absolute inset-0 mx-auto mt-20 sm:mt-20 lg:mt-20 grid max-w-6xl grid-rows-[1fr,auto] place-items-end px-6 ~py-6/12 z-30 pointer-events-none">
