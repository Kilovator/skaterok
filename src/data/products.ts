...
export const electricProducts: Product[] = [
  ...
  {
    id: "euc-3",
    name: "KingSong S18 Suspension EUC",
    category: "euc",
    price: 59999,
    rating: 4.9,
    reviewsCount: 110,
    specs: { speed: "50 km/h", range: "100 km", power: "2200W", weight: "25 kg" },
    description: "Futurystyczny design z kaskadowym zawieszeniem, ergonomicznymi padami nożnymi i automatycznymi światłami drogowymi.",
    image: { src: "https://images.unsplash.com/photo-1517649763962-0c623266010b?auto=format&fit=crop&w=800&q=80", alt: "KingSong S18 Suspension" },
    images: [
