...
export function CartButton() {
  ...
  return (
    <button
      ...
      className="button-cutout group inline-flex items-center gap-1.5 sm:gap-2.5 bg-gradient-to-b from-brand-amethyst to-brand-pale from-25% to-75% bg-[length:100%_400%] px-2 sm:px-3.5 py-1.5 sm:py-2 text-xs sm:text-sm font-semibold text-white transition-[filter,background-position] duration-300 hover:bg-bottom hover:text-black whitespace-nowrap flex-row shrink-0"
    >
