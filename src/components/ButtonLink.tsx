...
export type ButtonProps = ComponentPropsWithoutRef<typeof Link> & {
  ...
  return (
    <Link
      ...
      className={clsx(
        ...
        color === "purple" &&
          "from-brand-deep to-brand-amethyst text-white hover:text-white",
        color === "lime" &&
          "from-brand-pale to-brand-silver text-black hover:text-black",
        className
      )}
      {...props}
    >
