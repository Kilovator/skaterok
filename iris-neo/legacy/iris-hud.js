// iris-hud.js — dynamic HUD engine: animated charts, counters, data stream, info focus panel
(function () {
  ...
  /* ─── refresh all ─── */
  function refreshHUD() { drawCharts(); drawBurst(); }
  ...
  window.initHUD = function () {
    ...
    startLiveTickers();
    initInfoPanel();
    window.addEventListener('resize', () => { layoutCallouts(); buildRulers(); });
  };
